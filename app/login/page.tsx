            ...
            <div className="flex bg-gray-100 rounded-lg p-1">
              <button
                ...
                className={`flex-1 flex items-center justify-center space-x-2 py-2 px-4 rounded-md text-sm font-medium transition-colors ${
                  userType === "worker" ? "bg-white text-blue-600 shadow-sm" : "text-gray-600 hover:text-gray-900"
                }`}
              >
              ...
              <button
                ...
                className={`flex-1 flex items-center justify-center space-x-2 py-2 px-4 rounded-md text-sm font-medium transition-colors ${
                  userType === "employer" ? "bg-white text-blue-600 shadow-sm" : "text-gray-600 hover:text-gray-900"
                }`}
              >
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Button type="submit" className="w-full bg-blue-600 hover:bg-blue-700">
                Sign In as {userType === "worker" ? "Worker" : "Employer"}
              </Button>
            </form>
